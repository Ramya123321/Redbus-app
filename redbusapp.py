...
# Home page setting
if web=="Home":
    slt.image("redbus.jpeg",width=200)
    ...
    slt.subheader(":blue[Developed-by:]  Ramya.K")
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            mydb = mysql.connector.connect(host="localhost", user="root", password="", database="RED_BUS_DETAILS")
